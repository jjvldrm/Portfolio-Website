...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">John Joseph Valderama
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                I am an aspiring front-end developer from Bulacan,
                a university student who takes up BS in Computer
                Engineering at Bulacan State University.</p>
