                    ...
                    <div className={toggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"}>
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Bulacan State University</span>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">St. Paul College San Rafael</span>
                                <div className="qualification__calendar">
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Elementary Education</h3>
                                <span className="qualification__subtitle">St. Paul College San Rafael</span>
                                <div className="qualification__calendar">
